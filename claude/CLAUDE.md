...
Consult it just as proactively as you write to it — before spending real effort investigating something or re-deriving why a piece of code is the way it is, check whether it's already written down there. But never leave a comment or reference in another repo's code pointing back at it (e.g. "see X notes") — those notes are personal, not something anyone else reading that code can follow.
